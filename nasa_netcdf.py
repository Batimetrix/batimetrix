...
print("=== SWOT NetCDF Dosya Kontrolu ===")
...
if "Content-Length" in r.headers:
    ...
    if boyut_mb < 50:
        print("Kucuk dosya - indirilebilir!")
    elif boyut_mb < 200:
        print("Orta boyut - indirmek 5-10 dakika surebilir")
    else:
        print("Buyuk dosya - OPeNDAP ile alt kume cekelim")
else:
